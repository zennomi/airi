...
const displayModelsPresets: DisplayModel[] = [
  ...
  { id: 'preset-live2d-ami', format: DisplayModelFormat.Live2dZip, type: 'url', url: '/assets/live2d/models/ami.zip', name: 'Ami (PTIT)', previewImage: '/assets/live2d/models/hiyori/preview.png', importedAt: 1733113886840 },
